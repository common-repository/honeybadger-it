...
<p><?php esc_html_e('Free and Securely make your workflow easier without giving away your data. HoneyBadger.IT does not store your shop data, it acts only as a front end for your shop with multiple functionalities, what is stored is data that you add on the platform, in example supplier details, sub product details etc','honeybadger-it');?>.</p>
...
<table class="widefat" id="hb-status-table" cellspacing="0">
    <tbody>
        ...
        <tr class="hb-show hb-red-color">
            ...
            <td><?php esc_html_e('WooCommerce','honeybadger-it');?></td>
            <td><?php esc_html_e('Not Active','honeybadger-it');?></td>
            <td><?php esc_html_e('HoneyBadger IT plugin requires WooCommerce to be activated and was tested from version 5.9.0','honeybadger-it');?> <strong>[<?php esc_html_e('Deal Breaker','honeybadger-it');?>]</strong></td>
        </tr>
        <?php
            $deal_breaker=true;
        }
